...
export default {
  data() {
    return {  
      ...
      ChartOptionName: '设备一周趋势折线图配置',
      optionList: [], //设备一周趋势折线图保存的历史配置信息
      // 编辑器显示状态
      editorShow: false,
      // 开关禁用状态
      isDisabled: true,
      ...
      const dataOption = {
        dataset: {
          ...
          source: [
            ...
            [this.currentWeek.startOfWeek, ...currentDayDevFocusAndErr(0)],
            [
            ...
            [this.currentWeek.endOfWeek, ...currentDayDevFocusAndErr(6)],
          ],
        },
      }
