...
export default {
  data() {
    return {
      ...
      ChartOptionName: '一周资源消耗统计图配置',
      optionList: [], //一周资源消耗统计图保存的历史配置信息
      // 编辑器显示状态
      editorShow: false,
      // 开关禁用状态
      isDisabled: true,
        ...
        dataset: {
          ...
          source: [
            ...
            },
            {
              ...
              使用: calc(ramData, 'used'),
              本周消耗: calc(ramData, 'consumed'),
            },
            {
              product: '存储(TB)',
              总量: calc(storageData, 'total'),
              使用: calc(storageData, 'used'),
              本周消耗: calc(storageData, 'consumed'),
            },
          ],
        },
      }
